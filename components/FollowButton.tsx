...
export function FollowButton({
      ...
      <button
        ...
        className={`rounded-lg px-4 py-1.5 text-[14px] font-semibold transition-all duration-200 active:scale-95 disabled:opacity-60 ${
          following
            ...
            : "bg-[#0095f6] text-white shadow-[0_4px_14px_-4px_rgba(0,149,246,0.7)] hover:bg-[#1877f2] hover:shadow-[0_6px_18px_-4px_rgba(0,149,246,0.8)]"
        }`}
      >
  ...
  return (
    <button
      ...
      onClick={toggle}
      disabled={busy}
      className="text-[12px] font-semibold text-[#0095f6] transition-all duration-200 hover:text-[#00376b] active:scale-95 disabled:opacity-60"
    >
      {following ? "Following" : "Follow"}
    </button>
  );
